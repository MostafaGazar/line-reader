...
# Based on https://github.com/zhixuhao/unet/blob/master/model.py#L13
def unet(network_input: NetworkInput) -> KerasModel:
    ...
    conv10 = Conv2D(network_input.number_of_classes, 1, activation='softmax')(conv9)

    return KerasModel(inputs=inputs, outputs=conv10)
