...
link: https://github.com/ysoullard/CTCModel
...
class CTCModel:
    ...
    def fit_generator(self, generator,
        ...
        out = self.model_train.fit_generator(generator, steps_per_epoch, epochs=epochs, verbose=verbose,
                                             ...
                                             max_queue_size=max_queue_size, workers=workers, initial_epoch=initial_epoch)
    ...
    def ctc_complete_analysis_lambda_func(args, **arguments):
        ...
        batch = tf_math_ops.log(tf.transpose(y_pred, perm=[1, 0, 2]) + 1e-8)
